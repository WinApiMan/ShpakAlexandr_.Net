...
{
    public class AdminService : IConsoleService<AdminService>
    {
        private readonly IConsoleService<CarService> _carService;

        private readonly IConsoleService<DriverService> _driverService;

        private readonly IConsoleService<OrderService> _orderService;

        public AdminService(IConsoleService<CarService> carService, IConsoleService<DriverService> driverService, IConsoleService<OrderService> orderService)
        {
